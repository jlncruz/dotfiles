...
;; Authors: jwintz <https://github.com/jwintz> (tweaked by jlncruz)
;; Maintainer:
;; Source: original
;;
;;; Commentary:
...
(def-doom-theme doom-opera-light-modded
  "A [modified] light Opera theme."

  ;; name        default   256       16
  ((bg         '("#fafafa" nil       nil )) ;; previous bg color: #fafafa
   ...
   (fg         '("#000000" "#000000" nil ))
   ;; #23e4c also a good color for fg-alt (line numbers)
   (fg-alt     '("#3e6570" "#757575" nil )) ;; line number color (previously #454545 for default and #757575 for 256)

   (grey       base4)
   (red        '("#99324b" "#ff6655" nil ))
   (orange     '("#ac4426" "#dd8844" nil ))
   (green      '("#04c933" "#99bb66" nil )) ;; previous green: #4f894c
   (teal       '("#29838d" "#44b9b1" nil ))
   (yellow     '("#9a7500" "#ECBE7B" nil ))
   (blue       '("#0a53f2" "#51afef" nil )) ;; previous blue: #3b6ea8
   (dark-blue  '("#5272AF" "#2257A0" nil ))
   (magenta    '("#97365b" "#c678dd" nil ))
   (pink       '("#f74fbc" "#c678dd" nil )) ;; new added color
   (violet     '("#842879" "#a9a1e1" nil ))
   (cyan       '("#3bdbdb" "#46D9FF" nil )) ;; previous cyan: #398eac
   ...
   (doc-comments   base7)
   (constants      magenta)
   (functions      cyan) ;; previously teal
   (keywords       blue)
   (methods        teal)
   (operators      blue)
   (type           yellow)
